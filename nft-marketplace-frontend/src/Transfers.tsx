...
export const Transfers: React.FC<IInputPropos> = (propos) => {
  ...
  const [cmap, setCMap] = useState<string>("");
            ...
            <AccordionItem>
                ...
                <AccordionPanel>
                  <Stack>
                    ...
                    <Flex>
                    <Input placeholder='x-min' value={xmin} onChange={e => setXmin(e.target.value)}/>
                    <Input placeholder='x-max' value={xmax} onChange={e => setXmax(e.target.value)}/>
                    <Input placeholder='y-min' value={ymin} onChange={e => setYmin(e.target.value)}/>
                    <Input placeholder='y-max' value={ymax} onChange={e => setYmax(e.target.value)}/>
                    </Flex>
                    <Input placeholder='bg color' value={bgcolor} onChange={e => setBGColor(e.target.value)}/>
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        sendMandelbrotInput( iterations, xmin, xmax, ymin, ymax, equation, bgcolor, cmap );
                      }}
                      disabled={!rollups}
                    >
                      Generate
